...
The root checkout was moved to current `codex/root-current-v01623`; this branch keeps the
old dirty work out of the root working tree without discarding it.
...
- Cherry-pick or re-port useful pieces onto a current `v0.16.23+` line after freshness checks.
