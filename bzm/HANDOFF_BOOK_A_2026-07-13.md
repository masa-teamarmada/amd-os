...
- **登場人物名の正本 = `BOOK_A_CHARACTER_NAMES.md`** (2026-07-13 命名セッションで全確定 — 名前持ち11人: 柏木/志野/戸倉/楢原[旧柳井]/瀬戸/灘[旧世良]/真柴/笹本/甲斐/湊/磐井。野々村・宮原・藤野・青柳・湯浅・桐山は退場。※本 handoff 旧版の「仮名12名リスト」は失効 — 新キャラの命名・既存名の使用可否は必ず台帳を見る)。
