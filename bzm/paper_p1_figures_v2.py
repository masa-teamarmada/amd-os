...
# ---------------------------------------------------------------- Figure 4
# model/cases/SCORES.md (凍結版) の21件。単位は10億円 (JPY bn)。
# layer: "pre" = 未会社化 (主標本) / "inc" = 会社化済みスピンアウト (遡及評価)
#        "ext" = ドメイン外 (既存企業内シーズ・法人化の意思なし)
SCORES = [
 ("F2·R0", 42.40, 48.97, 58.30, "inc"), ("F1·R0", 5.670, 7.690, 11.970, "inc"),
 ("F2·R0", 4.820, 6.220, 7.230, "pre"),  ("F1·R0", 5.330, 5.330, 5.330, "inc"),
 ("F1·R1", 2.600, 4.580, 6.180, "pre"),  ("F2·R0", 2.620, 3.380, 4.150, "inc"),
 ("F2·R0", 0.980, 1.400, 1.700, "pre"),  ("F1·R0", 0.700, 0.980, 2.220, "inc"),
 ("F1·R0", 0.850, 0.910, 0.970, "inc"),  ("F1·R0", 0.470, 0.620, 0.820, "inc"),
 ("F1·R0", 0.340, 0.520, 0.740, "pre"),  ("F2·R0", 0.470, 0.500, 0.550, "inc"),
 ("F2·R1", 0.300, 0.300, 0.300, "inc"),  ("F1·R0", 0.250, 0.300, 0.360, "inc"),
 ("F1·R0", 0.0598, 0.110, 0.150, "pre"), ("F2·R0", 0.0928, 0.100, 0.160, "pre"),
 ("F1·R2", 0.0788, 0.0866, 0.0961, "inc"), ("F2·R1", 0.0403, 0.0403, 0.0404, "inc"),
