...
*Draft v2.1 (full working draft). Target: Journal of Technology Transfer. Word count (main text): ~8,900. The model version is frozen (main commit 34aaa284; approvals #2026-08-29-1 and #2026-08-29-2; 29 Aug 2026 — recorded in SM-G). Remaining placeholders — figures and the dual-scoring distribution — await the frozen-version computation pass.*
