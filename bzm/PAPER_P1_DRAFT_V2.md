...
*Draft v3.1 (full working draft). Target: Journal of Technology Transfer. Word count (main text): ~8,900. The model version and its inputs are frozen (main commit 91385d77; approvals #2026-08-29-1 and #2026-08-29-2 plus the input-placement corrections of 29 Aug 2026 — recorded in SM-G). Five figures are computed at the frozen version. No placeholders remain.*
