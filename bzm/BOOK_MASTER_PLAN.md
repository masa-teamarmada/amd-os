...
### 例外
- Book II load-bearing 章 (Ch 5/5.5/7/8/9/9.5/10.4/10.5/10.6/10.7): 章頭 → 数学導出 → 後付け校正例 → 章末前方参照 (Ch 9.5 は「後付け校正例」の代わりに SX/SIER・KENQ の Tier A 観測記述 + Ch 26b への実証 flush)
