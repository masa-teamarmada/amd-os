...
function doGet(e) {
  const __BUILD__ = "2026-01-11T16:xx_FREEE_FIX_v1";
  ...
  // ★timeline 追加（PJ配下）
  if ((page === "charter" || page === "billing" || page === "navigator" || page === "timeline" || page === "cockpit") && !canAccessProject_(projectId)) {
  ...
  if (page === "charter") {
    ...
    fileName = "225_ProjectCockpit";

  } else if (page === "monthlyreport") {
    fileName = "401_MonthlyReport_WebApp";
  }
  ...
  t.billingUrl = baseUrl + "?page=billing"
    + (projectId ? "&projectId=" + encodeURIComponent(projectId) : "")
    + (projectName ? "&projectName=" + encodeURIComponent(projectName) : "");
