...
> 「コスト試算」タブ（2026-08-23追加、**全PJ常設**、2026-09-13 二段階化・シミュレーター化・作業の流れとオフサイト、2026-09-14 方式と装置の分離・誰がやるか・誰が持つか・年間処理量から年に作る量・共通の作業単価と CAPEX / OPEX の区分・上端の槽を外し効かない前提を薄く出す・顧客工場の装置の費用を顧客に）。前提（変数）・費用明細・作業リスト
