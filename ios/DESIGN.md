...
2026-09-16: PWA adminに`/admin/change-history`を追加。2026-09-16以降のOS全体のデータ変更を、実行者・日時・対象・変更前後のセットで表示する。`/admin/access`最上段に未許可外部アカウントの承認待ちを追加し、まさへのSlack DMから研究機関ワークスペースの閲覧許可/拒否を決められる。PWA専用で、iOS/macOS/Androidのネイティブ画面は未移植。
