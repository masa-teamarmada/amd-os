...
> モノレポ全体の方針は `../AGENTS.md`。iOS 固有の内容はこのファイルに全部ある。
...
| `/Users/masa/projects/AMD/amd-os/ios` | Mac での実作業ローカルクローン | ✅ 高 |
| `/Users/masa/projects/AMD/amd-os/ios/.claude/worktrees/...` | 一時的な git worktree | ✅ 高 |
...
各 md は `AGENTS.md` / このファイル から辿れる構造。新規 md を作ったら必ずここに追記する。
...
[Mac] セッション開始時の 4 ステップ実行（未 push commit 検知）
  ↓
[Mac] /Users/masa/projects/AMD/amd-os/ios で Swift コード編集
