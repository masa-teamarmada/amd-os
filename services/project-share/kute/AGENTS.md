# AGENTS.md — services/project-share/kute

KUTE向けのPJ別 Project Share インスタンス。AMD OS PWAとは独立したVercelサービスとして扱う。

- 公開URL: `https://kute.team-armada.jp`
- Vercelプロジェクト: `kute-project-share`
- Vercel Blob: private store `kute-project-share`、prefix `kute/files/`
