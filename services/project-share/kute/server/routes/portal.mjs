...
<title>KUTE PROJECT SHARE</title>
<style>
  :root {
    color-scheme: light;
    --blue: #1A8FE6;
...
<body>
  <header class="top">
    <div class="brand">
      ...
      <span class="brand-title">KUTE PROJECT SHARE</span>
    </div>
  ...
  <script type="module">
    ...
    async function uploadFiles(fileList) {
      ...
      for (const file of list) {
        ...
        setProgress(0);
        const prefix = currentFolder ? "kute/files/" + currentFolder + "/" : "kute/files/";
        try {
