...
<body>
  <header class="top">
    <div class="brand">
      ...
      <span class="brand-title">SX PROJECT SHARE</span>
    </div>
  ...
  <script type="module">
    ...
    function dragGripSvg() {
      return '<svg class="drag-grip" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><circle sx="5" cy="3" r="1.3"/><circle sx="11" cy="3" r="1.3"/><circle sx="5" cy="8" r="1.3"/><circle sx="11" cy="8" r="1.3"/><circle sx="5" cy="13" r="1.3"/><circle sx="11" cy="13" r="1.3"/></svg>';
    }
    ...
    async function uploadFiles(fileList) {
      ...
      for (const file of list) {
        ...
        setProgress(0);
        const prefix = currentFolder ? "sx/files/" + currentFolder + "/" : "sx/files/";
        try {
