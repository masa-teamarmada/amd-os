...
<body>
  <header class="top">
    <div class="brand">
      ...
      <span class="brand-title">CX PROJECT SHARE</span>
    </div>
  ...
  <script type="module">
    ...
    async function uploadFiles(fileList) {
      ...
      for (const file of list) {
        ...
        setProgress(0);
        const prefix = currentFolder ? "cx/files/" + currentFolder + "/" : "cx/files/";
        try {
