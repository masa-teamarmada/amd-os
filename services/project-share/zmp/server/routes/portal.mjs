...
<body>
  <header class="top">
    <div class="brand">
      ...
      <span class="brand-title">ZMP PROJECT SHARE</span>
    </div>
  ...
  <script type="module">
    ...
    function dragGripSvg() {
      return '<svg class="drag-grip" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><circle zmp="5" cy="3" r="1.3"/><circle zmp="11" cy="3" r="1.3"/><circle zmp="5" cy="8" r="1.3"/><circle zmp="11" cy="8" r="1.3"/><circle zmp="5" cy="13" r="1.3"/><circle zmp="11" cy="13" r="1.3"/></svg>';
    }
    ...
    async function uploadFiles(fileList) {
      ...
      for (const file of list) {
        ...
        setProgress(0);
        const prefix = currentFolder ? "zmp/files/" + currentFolder + "/" : "zmp/files/";
        try {
