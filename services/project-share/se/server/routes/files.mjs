import { listDirectory, deleteFile, moveFile, SameLocationError, DestinationExistsError } from "../lib/blobStore.mjs";
import { isWithinFilesPrefix, sanitizeFolderPath } from "../lib/pathGuard.mjs";
...
export async function handleFilesRoute(req, res, { isAuthed, moveFileFn = moveFile }) {
  if (!isAuthed) {
  ...
  if (req.method === "PATCH") {
    ...
    if (!pathname || !isWithinFilesPrefix(pathname) || targetFolder === null) {
