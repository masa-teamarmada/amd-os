...
- 外部リサーチ機能とマニュアル表示はbuild `v3.71.1` / `f8b32f16`で確認済み。handoffは`170ea1a7`と`95f6964a`、Project Share救出を含むcloseout時点の最新mainは`123cf8c8`。productionはbuild `v3.71.3` / `123cf8c8`まで一致確認した。この最終追記commitでlive SHAはさらに進むため、次セッション開始時に`/api/build-info`と`origin/main`を照合する。
