...
description: AMD OS weekly L2 evidence routine for W-1 (= old W-1 VC News / Funding Signals VC News / Funding Signals). Runs as a Claude routine on claude.ai/code/routines, weekly Saturday 09:00 JST. Collects reviewable VC news, fund formation, investment activity, dry powder, and fundraising-related public signals for AMD deeptech strategy. Does not revive PWA/Vercel LLM cron, does not auto-confirm VC/fund records, and emits candidates / outbox / blocked summary when the safe write path is unclear.
---

# AMD OS Weekly VC / Funding Signals routine (W-1)

> **これは何か**: 旧 W-1 VC News / Funding Signals を **W-1** として weekly cadence に分離した Claude routine。
