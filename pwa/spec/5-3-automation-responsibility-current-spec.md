...
| **D-13** | Contract Signals | `contract_signals` / `contracts` / `contract_documents` | Claude routine `amd-os-l2-consolidated-evidence` Phase K + PWA route `POST /api/contracts/extract-l2` | daily 08:00 JST | 契約管理 `/admin/contracts`、l2_notifications(l2_kind='contract_signals') |
