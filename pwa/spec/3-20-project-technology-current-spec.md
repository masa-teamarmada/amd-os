...
## 6. 投入済みデータ (2026-09-03 時点)

| PJ | トピック | 行数 | 主な出所 |
|---|---|---|---|
| p21 (SX) | 解説 / 培養の成立条件 / リアクターの運転条件 / 対象にできる物質 / 選好 / 限界 / 星取り表 / 有価物 / 単価と原価の推移 / バイオ燃料 / 到達実績 | 144 | 2025-11-05 杉浦先生の文字起こし、SX定例MTG、★SolvioraX_m³換算版、SX_コスト試算 各版、260819 バイオ燃料アップサイド検討資料 |
