...
- source refs が弱い推測
- 既存 signal の言い換え
- **些細な人事の出来事**（2026-08-28 追加、2026-09-04 に範囲を訂正。下記）

### 人・組織の線引き

> **2026-09-04 まさ訂正。「人と組織の話は経営ハイライトに書かない」というルールは作っていない。**
> 「重要なポジションの人が抜けたとか新しく参画したとかは絶対書くべき。
> 8/28のは、何か人事に関するどうでもいい些細なことをハイライトに入れられたから、些細なことは書かないで、と伝えたんだと思う。
> それを勘違いして組織の話は書かない、と解釈したんじゃないかな。」

**重要なポジションの人が抜けた・新しく参画した、は必ず経営ハイライトへ書く。**
所属や報酬が無いまま中核として動いている人の存在も、経営ハイライトに書く事実である
（まさ 2026-09-04:「会社に所属してないという理由だけで除外されるべきではない。これこそがCEOに必要な巻き込み力」）。

経営ハイライトへ入れないのは**些細な人事の出来事**と、
人の性格・対人の癖のような**日付を持たない恒常的な性質**だけ。
後者の行き先はPJコックピット「スコア詳細」タブの《組織》（[4-9](4-9-project-org-section-current-spec.md)）で、
そこでは経営チームの八機能の充足を判定する材料として使われる。
**片方だけに置く決まりではない。** 担い手の獲得・喪失は経営ハイライトの事象であり、
同時に八機能の充足の材料でもあるので、両方に置いてよい。

| 例 | どちらか | 理由 |
|---|---|---|
| 「起源PIが事業会社との商談で壁を作り、関係づくりを妨げている」 | 組織 | 人の恒常的な性質。日付のある事象ではない |
| 「チームに一体感があり設立前としては成熟している」 | 経営ハイライト＋組織 | CEOの巻き込み力の実績なので経営ハイライトに置く（まさ 2026-09-04 訂正。旧版はここを「組織」だけにしていた） |
| 「所属も報酬も無いメンバーが夜も休日も開発を進めている」 | 経営ハイライト＋組織 | 同上。担い手が実際に動いている事実は経営の材料 |
| 「主要メンバーが制度上の理由で新会社へ正式参画できない」 | 経営ハイライト＋組織 | 重要ポジションの参画可否は起きたこと |
| 「事業範囲を広げない経営判断が固定されている」 | 組織 | 意思決定の構え。特定の日の決定ではない |
| 「技術の鍵を握るメンバーを外し、3名で誰も作れなくなった」 | 経営ハイライト＋組織 | 起きたことなので残す。担い手の喪失は組織側にも観測として立てる |
