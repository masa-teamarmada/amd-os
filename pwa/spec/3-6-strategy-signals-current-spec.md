...
- source refs が弱い推測
- 既存 signal の言い換え
- **人の恒常的な性質と、組織・チームの状態**（2026-08-28 追加）

### 人・組織の話は《組織》へ回す

経営ハイライトは**日付を持つ事象**の棚。「起きたこと」なら人が絡んでいても入れてよいが、
人の性格・対人の癖・チームの成熟度・経営者の構えのような**事象ではない状態**は入れない。
行き先はPJコックピット「スコア詳細」タブの《組織》（[4-9](4-9-project-org-section-current-spec.md)）で、
そこでは経営チームの八機能の充足を判定する材料として使われる。

| 例 | どちらか | 理由 |
|---|---|---|
| 「起源PIが事業会社との商談で壁を作り、関係づくりを妨げている」 | 組織 | 人の恒常的な性質。日付のある事象ではない |
| 「チームに一体感があり設立前としては成熟している」 | 組織 | チームの状態。良い評価でも同じ |
