...
| 2026-06-02 | 4-5 | 追加 | BZM FRL/PRS由来の OS/DB hygiene review を追加し、spec viewer章登録、p18/p11/p06 founded_at、p09 JOYCLE support end/start、`pj_basic_facts_sync`、month precision policy、candidate SQL を整理 | DB write前に source conflict と derived knowledge sync の境界を固定し、司令塔判断と次workerを切れる状態にするため | えいみ-worker |
