...
| 2026-06-02 | 2-3 / 3-2 | 変更 | PJ終了判定の source hygiene guard と、終了月後の future-like draft 月次を継続支援根拠にしないルールを追記 | JOYCLE/p09 の `amd_support_ended_at` だけNULLで、`projects.status/end_ym` と venture narrative/master が終了側だったため、DB補正前の判定事故を防ぐ | えいみ-worker |
