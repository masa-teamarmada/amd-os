...
|---|---|---|---|---|---|
| 2026-06-02 | 3-1 / spec-chapters | 変更 | L2 taxonomy を ①〜⑬ へ拡張し、⑪ Atlas Signals、⑫ Macrotrend Evidence/Index、⑬ Member Weekly Activities の provenance、writer境界、outbox、PWA LLM cron禁止を追記。L2①は月末のみ、daily consolidated routine 対象は②④⑤⑦⑧⑨⑩⑪⑫、L2③⑥は MMOマシン Codex Desktop automation 維持と明記 | OS司令塔レビューで expanded taxonomy strategy が採用され、正本 spec を L2①〜⑬ に整合するため | えいみ |
