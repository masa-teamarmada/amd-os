...
| 2026-06-02 JST | 2-4 / 1-3 | 追加・変更 | PJ Logo Assets 仕様を追加し、`ProjectLogo` / `ProjectMention`、Dashboard stripe / Cockpit header表示、Drive候補review、`project_assets` 推奨設計、再構築監査を追記 | Drive上のPJロゴをOS内で安全に扱い、PJ一覧と本文mentionへ段階導入するため | えいみ-worker |
