...
2. Before Zero実践知をBZM理論へ入れる/入れない判断
...
7. BZM 7軸モデルとP×R×S/9軸候補の整合
   ...
   - 現状: まだBZM教科書への本格統合は未完。理論更新候補として扱うべき状態。
   - 残課題: 1事例過適合を避け、複数PJ retrofit・観測可能性・既存7軸で説明できない差分を確認してから理論更新候補にする。
