...
- **page-turner編集レビューと素材発掘ループ**
  ...
  - 現状: `Textbook public manuscript 00-06 scene-first rewrite` workerへ品質バー追加指示を送信済み。さらに `Textbook editorial critic page-turner audit` と `Textbook source mining field-knowledge harvest` を切り出し済み。2026-06-01に `pwa/bzm/textbook/runs/2026-06-01-ruthless-editor-full-book-audit-00-21-v3.md` を追加し、00-21全体を販売本として68/100、本文rewrite前に artifact spine / Ch05 traveling artifact / Ch11-12 cooling / Ch15-21 roughen-and-deepen / post-Ch21 toolkit が必要と診断。
  - 残課題: ruthless editor audit v3 と source mining v3 を司令塔レビューし、次の本文rewrite workerへ P0/P1/P2 指示として差し戻す。以後の章も同じ編集循環で、魅力度と内容量の両方を上げる。
