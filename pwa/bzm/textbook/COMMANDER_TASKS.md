...
- **page-turner編集レビューと素材発掘ループ**
  ...
  - 残課題: `table extraction / toolkit appendix`、`support boundary pass`、Ch00〜Ch24 surgical residue passを切り、v6素材台帳、Act III source mining素材、Act V source mining素材を本文へ直接貼らずcomposite scene / tool artifact化して反映する。Ch08/13/18 overlap compressionとCh19 RESOURCE_SHIFT artifact passは2026-06-02に完了。
  - 次worker候補: Field Toolkit appendix UI/copy cleanup、support boundary pass、Ch00〜Ch24 surgical residue pass。
