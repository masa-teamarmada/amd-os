...
- 2026-06-02: `Textbook Ch00-Ch21 surgical narrative residue pass` 完了。Ch03のvisible Act語、Ch14/15/16/18/20/21の理論名早出し・scaffolding、Ch07/08/12/13の講義感/hidden listを局所圧縮。成果物: `pwa/bzm/textbook/runs/2026-06-02-ch00-21-surgical-narrative-residue-pass.md`。次worker候補: `Field Toolkit appendix separation pass`。
