...
- **page-turner編集レビューと素材発掘ループ**
  ...
  - 残課題: Ch15〜Ch24 cold-reader/editor review、`table extraction / toolkit appendix`、`support boundary pass`、Ch00〜Ch24 surgical residue passを切り、v6素材台帳、Act III source mining素材、Act V source mining素材を本文へ直接貼らずcomposite scene / tool artifact化して反映する。
