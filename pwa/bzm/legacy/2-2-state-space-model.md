...
![複素固有値ペアが生む減衰螺旋](/bzm/f2_state_space_spiral.png)

> **図 2-2.** 複素固有値ペア $\lambda = \alpha \pm i\beta$ が生む減衰螺旋（時間軸を第 3 軸に取って可視化）。周期 $T = 2\pi/\beta$ で回りながら、時定数 $\tau = -1/\alpha$ で均衡（緑点）へ収束します。$\alpha<0$ ゆえ内向きに巻く螺旋になります。
