...
|---|---|---|---|---|
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `occurred_at` | `timestamptz` | NOT NULL | `clock_timestamp()` |
| 3 | `schema_name` | `text` | NOT NULL | `'public'::text` |
| 4 | `table_name` | `text` | NOT NULL | `` |
| 5 | `operation` | `text` | NOT NULL | `` |
| 6 | `record_pk` | `jsonb` | NOT NULL | `'{}'::jsonb` |
| 7 | `actor_id` | `text` | NULL | `` |
| 8 | `actor_label` | `text` | NOT NULL | `` |
| 9 | `actor_source` | `text` | NOT NULL | `` |
| 10 | `changed_fields` | `_text` | NOT NULL | `'{}'::text[]` |
| 11 | `before_values` | `jsonb` | NOT NULL | `'{}'::jsonb` |
| 12 | `after_values` | `jsonb` | NOT NULL | `'{}'::jsonb` |
| 13 | `undo_before_values` | `jsonb` | NULL | `` |
| 14 | `undo_after_values` | `jsonb` | NULL | `` |
| 15 | `undo_supported` | `bool` | NOT NULL | `false` |
| 16 | `undo_block_reason` | `text` | NULL | `` |
| 17 | `undo_of_history_id` | `uuid` | NULL | `` |
| 18 | `transaction_id` | `int8` | NOT NULL | `txid_current()` |
...
| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `account_id` | `text` | NOT NULL | `` |
| 2 | `name` | `text` | NOT NULL | `` |
| 3 | `short_name` | `text` | NOT NULL | `` |
| 4 | `institution` | `text` | NOT NULL | `` |
| 5 | `purpose` | `text` | NULL | `` |
| 6 | `sort_order` | `int4` | NOT NULL | `100` |
| 7 | `is_active` | `bool` | NOT NULL | `true` |
| 8 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 9 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 10 | `freee_walletable_type` | `text` | NULL | `` |
| 11 | `freee_walletable_id` | `int8` | NULL | `` |
| 12 | `freee_sync_from` | `date` | NULL | `` |
| 13 | `freee_synced_at` | `timestamptz` | NULL | `` |
...
| 3 | `entry_date` | `date` | NOT NULL | `` |
| 4 | `seq` | `int4` | NOT NULL | `0` |
| 5 | `counterparty` | `text` | NULL | `` |
| 6 | `transfer_name` | `text` | NULL | `` |
| 7 | `withdrawal` | `int8` | NOT NULL | `0` |
| 8 | `deposit` | `int8` | NOT NULL | `0` |
| 9 | `balance` | `int8` | NULL | `` |
| 10 | `category` | `text` | NULL | `` |
| 11 | `target_month` | `text` | NULL | `` |
| 12 | `note` | `text` | NULL | `` |
| 13 | `is_planned` | `bool` | NOT NULL | `false` |
| 14 | `source` | `text` | NOT NULL | `'sheet_import'::text` |
| 15 | `source_row` | `int8` | NULL | `` |
| 16 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 17 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `id` | `int8` | NOT NULL | `nextval('ewir_rename_backup_20260912_id_seq'::regclass)` |
| 2 | `tbl` | `text` | NOT NULL | `` |
| 3 | `col` | `text` | NOT NULL | `` |
| 4 | `pk_cols` | `text` | NULL | `` |
| 5 | `row_before` | `jsonb` | NOT NULL | `` |
| 6 | `created_at` | `timestamptz` | NOT NULL | `now()` |

## ewir_rename_targets_20260912
...
| 9 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 10 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 11 | `compare_group` | `text` | NULL | `` |
| 12 | `compare_sort` | `int2` | NULL | `` |
| 13 | `compare_label` | `text` | NULL | `` |
...
| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `recommendation_id` | `text` | NOT NULL | `` |
| 2 | `policy_item_id` | `text` | NULL | `` |
| 3 | `topic` | `text` | NOT NULL | `` |
| 4 | `stance` | `text` | NOT NULL | `'open'::text` |
| 5 | `recommendation` | `text` | NOT NULL | `` |
| 6 | `conditions` | `text` | NULL | `` |
| 7 | `rationale` | `text` | NULL | `` |
| 8 | `evidence_note` | `text` | NULL | `` |
| 9 | `stat_note` | `text` | NULL | `` |
| 10 | `sort_order` | `int4` | NOT NULL | `100` |
| 11 | `is_active` | `bool` | NOT NULL | `true` |
| 12 | `updated_by` | `text` | NULL | `` |
| 13 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 14 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
|---|---|---|---|---|
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `loan_id` | `text` | NOT NULL | `` |
| 3 | `event_date` | `date` | NOT NULL | `` |
| 4 | `kind` | `text` | NOT NULL | `` |
| 5 | `amount` | `int8` | NOT NULL | `` |
| 6 | `principal_amount` | `int8` | NULL | `` |
| 7 | `interest_amount` | `int8` | NULL | `` |
| 8 | `is_planned` | `bool` | NOT NULL | `false` |
| 9 | `note` | `text` | NULL | `` |
| 10 | `source` | `text` | NOT NULL | `'sheet_import'::text` |
| 11 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 12 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `loan_id` | `text` | NOT NULL | `` |
| 2 | `lender` | `text` | NOT NULL | `` |
| 3 | `short_name` | `text` | NOT NULL | `` |
| 4 | `account_id` | `text` | NULL | `` |
| 5 | `annual_rate` | `numeric` | NOT NULL | `` |
| 6 | `day_count_basis` | `int4` | NOT NULL | `365` |
| 7 | `repayment_type` | `text` | NOT NULL | `` |
| 8 | `contracted_on` | `date` | NULL | `` |
| 9 | `drawdown_on` | `date` | NULL | `` |
| 10 | `principal_amount` | `int8` | NULL | `` |
| 11 | `credit_limit` | `int8` | NULL | `` |
| 12 | `term_months` | `int4` | NULL | `` |
| 13 | `first_due_on` | `date` | NULL | `` |
| 14 | `note` | `text` | NULL | `` |
| 15 | `is_active` | `bool` | NOT NULL | `true` |
| 16 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 17 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `calendar_event_id` | `text` | NOT NULL | `` |
| 2 | `project_id` | `text` | NULL | `` |
| 3 | `title` | `text` | NOT NULL | `` |
| 4 | `meeting_start_at` | `timestamptz` | NOT NULL | `` |
| 5 | `meeting_end_at` | `timestamptz` | NULL | `` |
| 6 | `status` | `text` | NOT NULL | `'pending'::text` |
| 7 | `attempt_count` | `int4` | NOT NULL | `0` |
| 8 | `max_attempts` | `int4` | NOT NULL | `5` |
| 9 | `first_detected_at` | `timestamptz` | NOT NULL | `now()` |
| 10 | `last_emitted_at` | `timestamptz` | NULL | `` |
| 11 | `last_attempt_at` | `timestamptz` | NULL | `` |
| 12 | `last_outcome` | `text` | NULL | `` |
| 13 | `last_error` | `text` | NULL | `` |
| 14 | `detected_by` | `text` | NOT NULL | `'h1_candidate_gate'::text` |
| 15 | `notes` | `text` | NULL | `` |
| 16 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 17 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(predecessor_action_id,successor_action_id)` (constraint: `project_action_dependencies_predecessor_action_id_successor_key`)

| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `predecessor_action_id` | `uuid` | NOT NULL | `` |
| 4 | `successor_action_id` | `uuid` | NOT NULL | `` |
| 5 | `created_at` | `timestamptz` | NOT NULL | `now()` |

## project_action_owners

行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(action_id,member_id)` (constraint: `project_action_owners_pair_unique`)
...
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `parent_id` | `uuid` | NULL | `` |
| 4 | `title` | `text` | NOT NULL | `` |
| 5 | `detail` | `text` | NULL | `` |
| 6 | `action_kind` | `text` | NOT NULL | `'work'::text` |
| 7 | `status` | `text` | NOT NULL | `'unassessed'::text` |
| 8 | `owner_label` | `text` | NOT NULL | `'担当未確認'::text` |
| 9 | `planned_start` | `date` | NULL | `` |
| 10 | `planned_end` | `date` | NULL | `` |
| 11 | `actual_end` | `date` | NULL | `` |
| 12 | `date_certainty` | `text` | NOT NULL | `'provisional'::text` |
| 13 | `progress_pct` | `int4` | NOT NULL | `0` |
| 14 | `blocker` | `text` | NULL | `` |
| 15 | `done_criteria` | `text` | NULL | `` |
| 16 | `done_evidence` | `text` | NULL | `` |
| 17 | `target` | `text` | NULL | `` |
| 18 | `actual` | `text` | NULL | `` |
| 19 | `unit` | `text` | NULL | `` |
| 20 | `origin_kind` | `text` | NOT NULL | `'manual'::text` |
| 21 | `origin_ref` | `text` | NULL | `` |
| 22 | `origin_question_id` | `uuid` | NULL | `` |
| 23 | `sort_order` | `numeric` | NOT NULL | `0` |
| 24 | `last_verified_at` | `date` | NOT NULL | `CURRENT_DATE` |
| 25 | `created_by` | `text` | NULL | `` |
| 26 | `updated_by` | `text` | NULL | `` |
| 27 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 28 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 29 | `deleted_at` | `timestamptz` | NULL | `` |
| 30 | `deleted_by` | `text` | NULL | `` |
| 31 | `version` | `int4` | NOT NULL | `1` |
| 32 | `client_token` | `uuid` | NULL | `` |
| 33 | `review_state` | `text` | NOT NULL | `'accepted'::text` |
| 34 | `proposed_question_id` | `uuid` | NULL | `` |
| 35 | `proposal_reason` | `text` | NULL | `` |
| 36 | `estimated_pt` | `numeric` | NULL | `` |
| 37 | `accepted_pt` | `numeric` | NULL | `` |
| 38 | `accept_state` | `text` | NOT NULL | `'unassigned'::text` |
| 39 | `accepted_at` | `timestamptz` | NULL | `` |
| 40 | `accepted_by` | `text` | NULL | `` |
| 41 | `reviewed_at` | `timestamptz` | NULL | `` |
...
| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `change_id` | `int8` | NOT NULL | `nextval('project_cost_change_log_change_id_seq'::regclass)` |
| 2 | `table_name` | `text` | NOT NULL | `` |
| 3 | `row_id` | `text` | NOT NULL | `` |
| 4 | `cost_model_id` | `text` | NOT NULL | `` |
| 5 | `op` | `text` | NOT NULL | `` |
| 6 | `changed_columns` | `_text` | NOT NULL | `` |
| 7 | `old_values` | `jsonb` | NOT NULL | `` |
| 8 | `new_values` | `jsonb` | NULL | `` |
| 9 | `reason` | `text` | NULL | `` |
| 10 | `changed_by` | `text` | NULL | `` |
| 11 | `changed_at` | `timestamptz` | NOT NULL | `now()` |
...
| 24 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 25 | `strain` | `text` | NULL | `` |
| 26 | `application` | `text` | NULL | `` |
| 27 | `bearer` | `text` | NOT NULL | `'sx'::text` |
...
| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `cost_task_id` | `text` | NOT NULL | `` |
| 2 | `cost_model_id` | `text` | NOT NULL | `` |
| 3 | `scenario` | `text` | NOT NULL | `` |
| 4 | `strain` | `text` | NULL | `` |
| 5 | `application` | `text` | NULL | `` |
| 6 | `group_label` | `text` | NULL | `` |
| 7 | `label` | `text` | NOT NULL | `` |
| 8 | `hours_per_occurrence` | `numeric` | NULL | `` |
| 9 | `count_driver` | `text` | NOT NULL | `'fixed'::text` |
| 10 | `count_per_year` | `numeric` | NULL | `` |
| 11 | `hourly_rate` | `numeric` | NULL | `` |
| 12 | `expense_per_occurrence` | `numeric` | NOT NULL | `0` |
| 13 | `confidence` | `text` | NULL | `` |
| 14 | `source_kind` | `text` | NULL | `` |
| 15 | `owner` | `text` | NULL | `` |
| 16 | `note` | `text` | NULL | `` |
| 17 | `visibility` | `text` | NOT NULL | `'amd_internal'::text` |
...
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `summary` | `text` | NOT NULL | `` |
| 4 | `finding_kind` | `text` | NOT NULL | `'neutral'::text` |
| 5 | `observed_on` | `date` | NULL | `` |
| 6 | `source_label` | `text` | NOT NULL | `'出どころ未確認'::text` |
| 7 | `source_url` | `text` | NULL | `` |
| 8 | `confidence` | `text` | NOT NULL | `'unknown'::text` |
| 9 | `from_action_id` | `uuid` | NULL | `` |
| 10 | `sort_order` | `int4` | NOT NULL | `0` |
| 11 | `last_verified_at` | `date` | NOT NULL | `CURRENT_DATE` |
| 12 | `created_by` | `text` | NULL | `` |
| 13 | `updated_by` | `text` | NULL | `` |
| 14 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 15 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
| 19 | `client_token` | `uuid` | NULL | `` |
| 20 | `review_state` | `text` | NOT NULL | `'accepted'::text` |
| 21 | `proposed_question_id` | `uuid` | NULL | `` |
| 22 | `proposal_reason` | `text` | NULL | `` |
...
|---|---|---|---|---|
| 1 | `project_id` | `text` | NOT NULL | `` |
| 2 | `definition` | `jsonb` | NOT NULL | `` |
| 3 | `source_ref` | `text` | NOT NULL | `` |
...
| 18 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 19 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 20 | `operating_cash_flow_yen` | `int8` | NULL | `` |
...
## project_question_actions

行数 (概算): 221
PRIMARY KEY: `id`
UNIQUE: `(question_id,action_id)` (constraint: `project_question_actions_question_id_action_id_key`)

| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `question_id` | `uuid` | NOT NULL | `` |
| 4 | `action_id` | `uuid` | NOT NULL | `` |
| 5 | `created_at` | `timestamptz` | NOT NULL | `now()` |

## project_question_findings

行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(question_id,finding_id)` (constraint: `project_question_findings_question_id_finding_id_key`)
...
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `question_id` | `uuid` | NOT NULL | `` |
| 4 | `finding_id` | `uuid` | NOT NULL | `` |
| 5 | `created_at` | `timestamptz` | NOT NULL | `now()` |

## project_question_milestones

行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(question_id,milestone_id)` (constraint: `project_question_milestones_pair_unique`)
...
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `parent_id` | `uuid` | NULL | `` |
| 4 | `contribution` | `text` | NULL | `` |
| 5 | `title` | `text` | NOT NULL | `` |
| 6 | `background` | `text` | NULL | `` |
| 7 | `question_kind` | `text` | NOT NULL | `'open'::text` |
| 8 | `status` | `text` | NOT NULL | `'open'::text` |
| 9 | `answer` | `text` | NULL | `` |
| 10 | `answered_on` | `date` | NULL | `` |
| 11 | `answered_by` | `text` | NULL | `` |
| 12 | `drop_reason` | `text` | NULL | `` |
| 13 | `confidence` | `text` | NOT NULL | `'unknown'::text` |
| 14 | `owner_label` | `text` | NOT NULL | `'担当未確認'::text` |
| 15 | `due_date` | `date` | NULL | `` |
| 16 | `origin_kind` | `text` | NOT NULL | `'manual'::text` |
| 17 | `origin_ref` | `text` | NULL | `` |
| 18 | `origin_question_id` | `uuid` | NULL | `` |
| 19 | `sort_order` | `int4` | NOT NULL | `0` |
| 20 | `last_verified_at` | `date` | NOT NULL | `CURRENT_DATE` |
| 21 | `created_by` | `text` | NULL | `` |
| 22 | `updated_by` | `text` | NULL | `` |
| 23 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 24 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 25 | `deleted_at` | `timestamptz` | NULL | `` |
| 26 | `deleted_by` | `text` | NULL | `` |
| 27 | `version` | `int4` | NOT NULL | `1` |
| 28 | `client_token` | `uuid` | NULL | `` |
| 29 | `review_state` | `text` | NOT NULL | `'accepted'::text` |
| 30 | `proposed_parent_id` | `uuid` | NULL | `` |
| 31 | `proposed_contribution` | `text` | NULL | `` |
| 32 | `proposal_reason` | `text` | NULL | `` |
| 33 | `children_logic` | `text` | NOT NULL | `'all'::text` |
...
## project_slack_sources

行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(project_id,workspace_key,channel_id)` (constraint: `project_slack_sources_uniq`)

| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `workspace_key` | `text` | NOT NULL | `'armada'::text` |
| 4 | `channel_id` | `text` | NOT NULL | `` |
| 5 | `channel_name` | `text` | NULL | `` |
| 6 | `enabled` | `bool` | NOT NULL | `true` |
| 7 | `note` | `text` | NULL | `` |
| 8 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 9 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
| 3 | `track_key` | `text` | NOT NULL | `` |
| 4 | `title` | `text` | NOT NULL | `` |
| 5 | `description_md` | `text` | NULL | `` |
| 6 | `owner_member_id` | `text` | NULL | `` |
| 7 | `due_on` | `date` | NULL | `` |
| 8 | `status` | `text` | NOT NULL | `'planned'::text` |
| 9 | `linked_document_id` | `uuid` | NULL | `` |
| 10 | `client_token` | `uuid` | NULL | `` |
| 11 | `sort_order` | `int4` | NOT NULL | `0` |
| 12 | `created_by_member_id` | `text` | NULL | `` |
| 13 | `updated_by_member_id` | `text` | NULL | `` |
| 14 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 15 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 16 | `deleted_at` | `timestamptz` | NULL | `` |
| 17 | `deleted_by` | `text` | NULL | `` |
...
行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(project_id,track_key,document_id)` (constraint: `project_theme_documents_project_id_track_key_document_id_key`)
...
| 5 | `sort_order` | `int4` | NOT NULL | `0` |
| 6 | `created_by_member_id` | `text` | NULL | `` |
| 7 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 8 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 9 | `deleted_at` | `timestamptz` | NULL | `` |
| 10 | `deleted_by` | `text` | NULL | `` |
...
行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(project_id,track_key,meeting_id)` (constraint: `project_theme_meetings_project_id_track_key_meeting_id_key`)
...
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `track_key` | `text` | NOT NULL | `` |
| 4 | `meeting_id` | `text` | NOT NULL | `` |
| 5 | `client_token` | `uuid` | NULL | `` |
| 6 | `sort_order` | `int4` | NOT NULL | `0` |
| 7 | `created_by_member_id` | `text` | NULL | `` |
| 8 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 9 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 10 | `deleted_at` | `timestamptz` | NULL | `` |
| 11 | `deleted_by` | `text` | NULL | `` |
| 12 | `version` | `int4` | NOT NULL | `1` |

## project_theme_profiles

行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(project_id,track_key)` (constraint: `project_theme_profiles_project_id_track_key_key`)
...
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `track_key` | `text` | NOT NULL | `` |
| 4 | `purpose_md` | `text` | NULL | `` |
| 5 | `current_state_md` | `text` | NULL | `` |
| 6 | `next_focus_note` | `text` | NULL | `` |
| 7 | `created_by_member_id` | `text` | NULL | `` |
...
行数 (概算): -1
PRIMARY KEY: `id`
UNIQUE: `(project_id,from_kind,from_id,to_kind,to_id,relation)` (constraint: `project_theme_work_links_project_id_from_kind_from_id_to_ki_key`)
...
| 2 | `project_id` | `text` | NOT NULL | `` |
| 3 | `track_key` | `text` | NOT NULL | `` |
| 4 | `from_kind` | `text` | NOT NULL | `` |
| 5 | `from_id` | `text` | NOT NULL | `` |
| 6 | `to_kind` | `text` | NOT NULL | `` |
| 7 | `to_id` | `text` | NOT NULL | `` |
| 8 | `relation` | `text` | NOT NULL | `'relates_to'::text` |
| 9 | `client_token` | `uuid` | NULL | `` |
| 10 | `created_by_member_id` | `text` | NULL | `` |
| 11 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 12 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 13 | `deleted_at` | `timestamptz` | NULL | `` |
| 14 | `deleted_by` | `text` | NULL | `` |
...
| 2 | `seed_id` | `uuid` | NOT NULL | `` |
| 3 | `category` | `text` | NOT NULL | `` |
| 4 | `fact` | `text` | NOT NULL | `` |
| 5 | `detail` | `text` | NULL | `` |
| 6 | `observed_on` | `date` | NOT NULL | `` |
| 7 | `heard_at` | `text` | NULL | `` |
| 8 | `source_kind` | `text` | NOT NULL | `` |
| 9 | `confidence` | `text` | NOT NULL | `` |
| 10 | `sps_relevance` | `_text` | NOT NULL | `'{}'::text[]` |
| 11 | `source_url` | `text` | NULL | `` |
| 12 | `created_by` | `text` | NULL | `` |
| 13 | `updated_by` | `text` | NULL | `` |
| 14 | `created_at` | `timestamptz` | NOT NULL | `now()` |
...
| 53 | `seed_no` | `int4` | NULL | `` |
| 54 | `additional_research_hypothesis` | `text` | NULL | `` |
| 55 | `company_note` | `text` | NULL | `` |
...
行数 (概算): 96
PRIMARY KEY: `id`
UNIQUE: `(normalized_name)` (constraint: `startup_companies_normalized_name_key`)

| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `canonical_name` | `text` | NOT NULL | `` |
| 3 | `name_en` | `text` | NULL | `` |
| 4 | `normalized_name` | `text` | NOT NULL | `` |
| 5 | `aliases` | `_text` | NOT NULL | `'{}'::text[]` |
| 6 | `website` | `text` | NULL | `` |
| 7 | `our_project_id` | `text` | NULL | `` |
| 8 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 9 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
行数 (概算): 29
PRIMARY KEY: `id`
UNIQUE: `(dedupe_key)` (constraint: `startup_funding_rounds_dedupe_key_key`)

| # | column | type | nullable | default |
|---|---|---|---|---|
| 1 | `id` | `uuid` | NOT NULL | `gen_random_uuid()` |
| 2 | `startup_id` | `uuid` | NOT NULL | `` |
| 3 | `dedupe_key` | `text` | NOT NULL | `` |
| 4 | `round_label` | `text` | NULL | `` |
| 5 | `announced_on` | `date` | NULL | `` |
| 6 | `completed_on` | `date` | NULL | `` |
| 7 | `deal_status` | `text` | NOT NULL | `'unknown'::text` |
| 8 | `total_amount_low` | `numeric` | NULL | `` |
| 9 | `total_amount_high` | `numeric` | NULL | `` |
| 10 | `total_amount_currency` | `text` | NOT NULL | `'JPY'::text` |
| 11 | `total_amount_disclosure` | `text` | NOT NULL | `'not_found'::text` |
| 12 | `source_url` | `text` | NULL | `` |
| 13 | `source_title` | `text` | NULL | `` |
| 14 | `evidence_note` | `text` | NULL | `` |
| 15 | `verification_status` | `text` | NOT NULL | `'candidate'::text` |
| 16 | `collected_by_model` | `text` | NULL | `` |
| 17 | `collected_at` | `timestamptz` | NULL | `` |
| 18 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 19 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
...
| 13 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 14 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
| 15 | `startup_id` | `uuid` | NULL | `` |
| 16 | `funding_round_id` | `uuid` | NULL | `` |
| 17 | `investor_amount_low` | `numeric` | NULL | `` |
| 18 | `investor_amount_high` | `numeric` | NULL | `` |
| 19 | `investor_amount_currency` | `text` | NOT NULL | `'JPY'::text` |
| 20 | `amount_disclosure` | `text` | NOT NULL | `'legacy_unclassified'::text` |
| 21 | `investor_role` | `text` | NOT NULL | `'participant'::text` |
| 22 | `deal_status` | `text` | NOT NULL | `'unknown'::text` |
| 23 | `verification_status` | `text` | NOT NULL | `'legacy_unreviewed'::text` |
| 24 | `collected_by_model` | `text` | NULL | `` |
| 25 | `collected_at` | `timestamptz` | NULL | `` |
...
| 21 | `investment_history_collected_at` | `timestamptz` | NULL | `` |
...
| 3 | `requested_path` | `text` | NOT NULL | `` |
| 4 | `target_kind` | `text` | NOT NULL | `'unspecified'::text` |
| 5 | `workspace_slug` | `text` | NULL | `` |
| 6 | `project_id` | `text` | NULL | `` |
| 7 | `status` | `text` | NOT NULL | `'pending'::text` |
| 8 | `request_count` | `int4` | NOT NULL | `1` |
| 9 | `first_requested_at` | `timestamptz` | NOT NULL | `clock_timestamp()` |
| 10 | `last_requested_at` | `timestamptz` | NOT NULL | `clock_timestamp()` |
| 11 | `user_account_id` | `uuid` | NULL | `` |
| 12 | `decided_at` | `timestamptz` | NULL | `` |
| 13 | `decided_by_member_id` | `text` | NULL | `` |
| 14 | `decision_source` | `text` | NULL | `` |
| 15 | `slack_channel_id` | `text` | NULL | `` |
| 16 | `slack_message_ts` | `text` | NULL | `` |
| 17 | `slack_notification_status` | `text` | NOT NULL | `'pending'::text` |
| 18 | `slack_notification_error` | `text` | NULL | `` |
| 19 | `last_slack_notified_at` | `timestamptz` | NULL | `` |
| 20 | `created_at` | `timestamptz` | NOT NULL | `clock_timestamp()` |
| 21 | `updated_at` | `timestamptz` | NOT NULL | `clock_timestamp()` |
