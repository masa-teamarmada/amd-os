...
| 5 | `description` | `text` | NULL | `` |
| 6 | `region` | `text` | NULL | `` |
| 7 | `contract_status` | `text` | NOT NULL | `'active'::text` |
| 8 | `sort_order` | `int4` | NOT NULL | `100` |
| 9 | `created_at` | `timestamptz` | NOT NULL | `now()` |
| 10 | `updated_at` | `timestamptz` | NOT NULL | `now()` |
