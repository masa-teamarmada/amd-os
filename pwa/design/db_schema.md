...
> 生成: `cd pwa && python3 -X utf8 scripts/dump_schema.py`  最終生成: 2026-07-02 12:25 JST
...
| 6 | `amount_yen` | `int4` | NOT NULL | `` |
| 7 | `applies_from_ym` | `text` | NOT NULL | `` |
| 8 | `status` | `text` | NOT NULL | `'active'::text` |
