...
| 5.6 | [l2_expanded_automation_strategy.md](l2_expanded_automation_strategy.md) | L2 拡張 taxonomy と Claude 定額 token / routine 上限内の抽出戦略 |
...
| L2データ正本リスト ⭐ | [l2_data_list.md](l2_data_list.md) |
