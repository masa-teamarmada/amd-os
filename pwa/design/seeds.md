...
- `confidence`: confirmed=一次資料または当事者で確認済 / reported=会議や人から聞いた話で裏取り前 (画面は「聞いた話」) / unconfirmed=未確認
