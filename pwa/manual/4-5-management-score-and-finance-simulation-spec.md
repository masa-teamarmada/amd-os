...
| └ 見込 (`status='sales'`) PJ の原価0は意図した前提 | — | 横引きは**プラン実在月が1つ以上ある PJ** の実績を伸ばす仕組みなので、まだ稼働実績が無い見込 PJ には基準が無く発動しない。2026-08-17 時点で該当は p32 NewCo業務委託 (2027-05〜 月¥600,000)、p33 CX再開 (2027-01〜 月¥274,000)、p34 PSI Step2新規 (2027-04〜2028-03 月¥400,000) の3本、計 月¥1,274,000 が原価0のまま粗利に乗る。**これは未対応の楽観ではなく、まさ確定 (2026-08-17) の前提**: 「Aだな。多分おれ1人で対応するし。メンバーに払う余裕がない」。この3本はまさ単独稼働を想定しており、外部メンバーへの支払が発生しないので原価0が正しい。実際にメンバーを入れる判断をした時点で報酬プランを作り、そこから原価が入る (プランができれば以後は横引きの基準にもなる)。p21 SX の後継は p32 NewCo で、SX 自体の契約延長は仕組み上存在しない |
