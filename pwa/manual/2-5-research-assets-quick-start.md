...
| `/poc` | PoC案件化の棚 | シーズと企業候補を組み合わせ、ヒアリング、PoC条件、謝礼、契約、収益分配を設計する |
...
PoC は、Seeds の下流で「どのシーズをどの企業に当てると、ヒアリングや有償PoCになりそうか」を組む場所。

| 操作 | 何を見る / 何をする |
|---|---|
| 検索 | シーズ、企業、相性仮説、ヒアリング論点、次アクションで探す |
| マッチ状態 filter | 候補、質問設計、紹介済、ヒアリング済、PoC設計中、PoC実施中、案件化を分ける |
| 企業状態 filter | 候補、リスト化、接触済、ヒアリング中、PoC設計可を分ける |
| マッチ案件を追加 | シーズ x 企業候補に、仮説、質問、謝礼、契約、資金、収益分配、次アクションを保存する |
| 企業候補を追加 | PoCを受けてくれそうな企業候補、業界タグ、過去PoC/紹介経路、謝礼メモを追加する |
| マトリックス | シーズ x 企業の空白を見て、まだ検討していない組み合わせを見つける |
...
- PoC は Seeds の代替ではない。研究シーズ本体は Seeds、企業候補や条件設計は PoC に分ける
