...
→ **判定ロジック詳細は [03 章 3.3 抽出パイプライン](03-data-and-extraction.md#33-抽出パイプライン)** + **[05 章 5.4 責務分担マトリクス](05-decisions-and-history.md#54-codex--claude--vercel--launchagent-責務分担マトリクス)** 参照。Atlas / Macrotrend / AMD Protocol との関係は **[07 章 判断エンジン](07-atlas-protocol-score-macrotrend.md)**。
