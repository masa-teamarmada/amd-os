...
## 経営ハイライトに入れないもの (2026-08-28 追加 / 2026-09-04 範囲を確定)

経営ハイライトは**会社としての大きな動き**の棚。人が絡んでいても「会社としての動き」なら入れてよいが、
**人の恒常的な性質、組織・チームの状態、些細な人事の出来事、個々のメンバーの参画可否・貢献ぶり・処遇の相談は入れない**。
...
> 同日、個々のメンバーの参画意向・貢献ぶり・参画拒否を4件ハイライトへ立てたのに対して:
> 「この４つは経営ハイライトに書くべきじゃないと思うので削除して。あくまで会社としての大きな動きに限定して。」

**「人と組織の話だから書かない」というカテゴリ禁止ではない。** 粒度の問題である。
会社としての大きな動きになるのは、代表・CxO級の就任や離脱、技術の担い手の恒久喪失、
設立の進め方そのものが組織へ及ぼした影響など。**迷ったら《組織》へ置き、上げるかはまさに確認する。**

| 例 | 行き先 |
|---|---|
| 起源PIが商談で壁を作り関係づくりを妨げている | 《組織》 |
| チームに一体感があり設立前としては成熟している | 《組織》（良い評価でも同じ） |
| メンバーの参画がほぼ確定した / 所属を断ってきた / 制度上の理由で正式参画できない | 《組織》（設立準備中の一人ひとりの調整は会社としての大きな動きではない。まさ 2026-09-04） |
| 事業範囲を広げない経営判断が固定されている | 《組織》 |
| 技術の鍵を握るメンバーを外し、誰も作れなくなった | 経営ハイライト＋《組織》 |
| 新会社設立の動きを始めた結果、母体の研究グループ内に不和が出はじめた | 経営ハイライト＋《組織》（設立の進め方が組織全体へ及ぼした影響なので会社の動き） |
| CEO候補と初回接触し参画可能性を探ることで合意した | 経営ハイライト |

《組織》はPJコックピットのスコア詳細タブの最下段。そこでは経営チームの八機能の充足を判定する材料になる。
毎日の自動抽出（L9）にも同じ除外規定が入っている。

2026-08-26〜28 に各PJの「死ぬとしたらどこからか」を洗い出した内容が、行き先が無いまま
経営ハイライトへ入っていた（まさ「これどうみても経営ハイライトじゃなくない？」）。4PJぶんを移設済み。
