...
`/seeds` / `/vcs` / `/scholar` の 3 つの外部探索アセット画面の開発者向け正本。 メンバー向け使い方は [09 章](09-research-assets-quick-start.md) を見る。
...
2026-05-22 以降 LLM / web_search 課金回避で自動 schedule 停止。 route は残してるので手動 review batch から起動可能 ([24 章](24-operations-settings-spec.md))。
...
- Run Now: `/admin/settings` の Cron Control から admin がキック可能 ([24 章](24-operations-settings-spec.md))
...
- 34 章 [Atlas / Macrotrend 詳細仕様](34-atlas-macrotrend-signal-spec.md)
- 23 章 [HUD / Venture Map 仕様](23-hud-and-venture-map-spec.md) (= 旧 seeds 切り離し履歴)
- 24 章 [Operations Settings](24-operations-settings-spec.md) (= cron 復活方法)
