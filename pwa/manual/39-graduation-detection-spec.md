...
戦略接近度カードを開くと内訳が見える ([29.6 戦略接近度](29-management-score-and-finance-simulation-spec.md#296-score-計算--v4)):
...
- バイタルサイン (= 接続元): [29 章 Management Score / Finance Simulation](29-management-score-and-finance-simulation-spec.md)
- まさえいMTG / 経営シグナル: [28 章 通知レビュー + 経営シグナル](28-notification-review-and-strategy-signals-spec.md)
- L2 抽出 routine (= シグナル 1 / 3 の LLM 抽出経路): [38 章 L2 Extraction Routines](38-l2-extraction-routines-spec.md)
