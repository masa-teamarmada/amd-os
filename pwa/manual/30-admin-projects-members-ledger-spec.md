...
凍結期間中の reports + meetings を Sonnet で再要約するのが `/api/cron/freeze-period-backfill` (= manual operation、 [24 章](24-operations-settings-spec.md))。
...
詳細は [05 章 §5.6](05-decisions-and-history.md#56-project_category-に-new_business-追加--2026-05-25)。
...
| `member_name` | 法律名 (= 契約書 / 支払通知書に使う) |
| `member_address` | 住所 (= 支払通知書) |
| `bank_info` | 振込先 (= 支払通知書) |
...
詳細は [10 章 メンバーの日常ワークフロー](10-member-workflows-quick-start.md)。
...
- 32 章 [Invoice / Billing Routine](32-invoice-and-billing-routine-spec.md) (= 請求書発行)
- 25 章 [Finance / Payment Confirm](25-finance-payment-confirm-spec.md) (= 入金確認)
- 31 章 [Admin Payouts / 支払通知書](31-admin-payouts-reward-notice-spec.md) (= 支払通知書発行)
- 04 章 [admin オペ](04-admin-ops.md) (= 月次ルーティン早見表)
- 05 章 [過去判断と経緯](05-decisions-and-history.md) (= status / project_category の経緯)
