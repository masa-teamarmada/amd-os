...
### 支払月は、入金の事実を推定より優先する (まさ指摘 2026-08-26)
...
そこで、`billing_cycles.payment_confirmed_at` (クライアントからの入金確認) がある稼働月は、推定より早ければ **入金月をそのまま支払月にする**。すでにメンバーへ支払った月 (`reward_paid_at`) は動かさない。
...
ただし入金が確認できた月は上のルールで前倒しされる。6月稼働分は 8/5 の入金確認で 9月払い→8月払いに動いた。7月稼働分も入金確認が入れば同じく前倒しされる。送付日を空にしても、入金後の前倒しは止まらない。
...
> 実例 (SX / 愛媛大学): 6月分の請求書は6月に送付済みで、入金は8月5日。しかし送付日が台帳に無かったため OS は「7月10日受領 → 9月払い」と推定し、6月稼働分のメンバー支払が9月扱いになっていた。入金の事実を優先する規則にしたことで、6月稼働分は入金月の8月の支払通知書へ乗る。
