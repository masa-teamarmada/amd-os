...
支払は毎月7日 (土日祝なら直前の営業日)。その回に乗せるには **支払日の前月末まで**に両方そろっていること。締切を置くのは、7日に振り込むために金額を確定して振込データを作る時間が要るため (まさ指摘 2026-08-29「6日の深夜に月初合意送られても振込する方は大変」)。締切後にそろった分は次の回へ回る。

請求書をいつ出したか、支払条件が何日かは、メンバーへの支払時期の計算には使わない。
...
- 立替の摘要が長い場合、PDFには品目を識別できる短い表記を渡す。末尾の長い括弧書きは申請台帳に残し、PDFの摘要欄から金額列へのはみ出しを防ぐ
