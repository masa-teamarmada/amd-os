...
Triple Helix は、世の中の流れを「学術」「産業」「政府」に分けて見る考え方。

- `mu_A`: 論文、研究予算、研究者コミュニティがどれくらい動いているか
- `mu_I`: 企業投資、VC投資、実装事例、競合の動きがどれくらいあるか
- `mu_G`: 政策、規制緩和、補助金、公募、政府文書がどれくらい後押ししているか

3つを平均ではなく幾何平均にしているのは、どれか1つだけ極端に高くても過大評価しないため。たとえば論文は多いが企業も政府も動いていない領域は、まだ事業化の追い風としては弱い。逆に、研究・企業・政策が同時に動いている領域は、SUが伸びる外部環境として強い。
