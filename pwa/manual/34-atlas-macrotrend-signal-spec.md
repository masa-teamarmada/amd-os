...
`/atlas` 系画面 (= signal / story / theme / divergence / macrotrend) の開発者向け正本。 メンバー向け使い方は [09 章](09-research-assets-quick-start.md) と [07 章](07-atlas-protocol-score-macrotrend.md)。
...
`/api/cron/triple-helix-recompute` (= manual operation、 [24 章](24-operations-settings-spec.md))。 8 domain × 16 quarter の BVAR/Kalman 再計算。 投入データの確認後に admin が手動キックする。
...
詳細は `pwa/design/aspi_lanes.md` と [24 章 Operations Settings](24-operations-settings-spec.md)。
...
- 07 章 [判断エンジン overview](07-atlas-protocol-score-macrotrend.md) (= Atlas + Protocol + Score + Macrotrend の関係)
- 09 章 [探索系アセットの使い方](09-research-assets-quick-start.md) (= ユーザー視点)
- 33 章 [Seeds / VC / Scholar 詳細仕様](33-research-assets-vc-seeds-scholar-spec.md)
- 23 章 [HUD / Venture Map 仕様](23-hud-and-venture-map-spec.md)
- 24 章 [Operations Settings](24-operations-settings-spec.md) (= 停止中 cron の復活方法)
