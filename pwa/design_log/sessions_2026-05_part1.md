# Sessions Log — 2026-05 (AMD OS PWA) — Part 1 (05-02〜05-13)

PWA セッション作業ログ (月内分割 part1)。索引・最新分は `sessions_2026-05.md` 参照。仕様 `SPEC_pwa.md` / バグ `BUGS.md` / 引き継ぎ `HANDOFF_pwa_rebuild.md`。
