...
- final handoff docs commit: `78909002 Refresh cockpit MS budget handoff`。
- final production `/api/build-info`: `v0.39.20` / `7890900291382db607d0244def3691632dbe97f4` / `dirty:false`。
