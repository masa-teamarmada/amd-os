...
async function collectInternalSignals(supabase: SupabaseClient, ym: string): Promise<RawSignal[]> {
  ...
  const [
    ...
    fetchAll(supabase, "project_ventures", "project_id,lane,lanes,outcome_pattern,amd_role,amd_support_started_at,amd_support_ended_at,updated_at,projects(project_name,client_name,news_search_query)"),
