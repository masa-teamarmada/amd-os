...
export const SURFACE_CATALOG: readonly SurfaceDefinition[] = [
  ...
  { id: "shared-project", title: "PJ ダッシュボード", domain: "project_execution", lens: "shared_project", status: "canonical", patterns: [/^\/project\/[^/]+\/workspace\/?$/] },
  { id: "weekly-control", title: "PJ 週次管制", domain: "project_execution", lens: "amd_internal_project", status: "transitional", patterns: [/^\/project\/[^/]+\/weekly-control\/?$/] },
  ...
  { id: "amd-score-retrofit", title: "AMD Score Retrofit", domain: "portfolio", lens: "exploration", status: "transitional", prefixes: ["/venture-map/amd-score/retrofit"] },
  { id: "amd-score", title: "AMD Score", domain: "portfolio", lens: "exploration", status: "canonical", prefixes: ["/venture-map/amd-score"] },
  ...
  { id: "venture-cyberspace", title: "Venture Cyberspace", domain: "portfolio", lens: "exploration", status: "mirror", prefixes: ["/venture-map/cyberspace"] },
...
export const ADMIN_SURFACE_GROUPS = [
  ...
  { label: "契約・お金", surfaceIds: ["admin-contracts", "admin-invoices", "admin-payouts", "admin-monthly-agreements", "admin-season-pl", "admin-finance"] },
