...
export const l2Datasets: L2Dataset[] = [
  ...
  },
  {
    ...
    source: "Windows MMO Codex Desktop automation amd-os-l6-meeting-flow / legacy GAS 153 + 074 stopped",
...
export const cronOperations: CronOperation[] = [
  ...
  // L2①/⑦/⑧/⑨/⑩/⑪はCodex automation/outbox、L2②〜⑥はMMO automation、L2⑫はPWA non-LLM aggregate、L2⑬はfuture subscription候補。
  {
  ...
  },
  {
    ...
    label: "L2 ② AMDプロトコル抽出 (MMO Codex Desktop automation)",
    layer: "Codex",
  ...
  },
  {
    ...
    label: "L2 ④ PJナレッジ抽出 (MMO Codex Desktop automation)",
    layer: "Codex",
  ...
  },
  {
    ...
    label: "L2 ⑤ メンバーナレッジ抽出 (MMO Codex Desktop automation)",
    layer: "Codex",
  ...
  },
  {
    ...
    label: "L2 ⑥ MTGサマリ + フロー (MMO Codex Desktop automation)",
    layer: "Codex",
