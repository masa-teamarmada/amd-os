  ...
  for (const projectId of projectIds) {
    ...
    const sourceHash = stableHash({
      ...
      termCandidates: projectTermCandidates.map((candidate) => ({
        ...
        monthlyReportSubmissionTiming: candidate.monthlyReportSubmissionTiming,
        monthlyReportSubmissionDeadline: candidate.monthlyReportSubmissionDeadline,
        monthlyReportSubmissionFormat: candidate.monthlyReportSubmissionFormat,
        monthlyReportSubmissionRequiredItems: candidate.monthlyReportSubmissionRequiredItems,
