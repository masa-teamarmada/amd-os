...
const elementDetails: Record<string, MaterialDetail> = {
  ...
  C: detail({ id: "element-c", family: "element", name: "炭素", code: "C", category: "非金属", summary: "黒鉛、炭素繊維、活性炭、ダイヤモンドまで構造で機能が激変する基盤元素。", properties: ["同素体が多い", "軽量", "導電・吸着・高強度を設計可能"], uses: ["LIB負極", "複合材", "吸着・触媒担体", "電極"], supplyCountries: ["天然黒鉛: 中国", "天然黒鉛: マダガスカル", "天然黒鉛: タンザニア"], reserves: "天然黒鉛の世界埋蔵量 約3.1億t（USGS 2026）。炭素全体の埋蔵量ではない。", balance: "電池grade球状黒鉛は採掘量より精製・球状化・被覆の集中がボトルネック。", circularity: "複合材は難しいが、電池黒鉛の再生・バイオ炭・CO2由来炭素は新市場。", chain: ["天然黒鉛 / 石油系原料 / バイオマス", "精製・炭化・黒鉛化", "負極材 / 炭素繊維 / 活性炭", "電池・モビリティ・環境"], amdFitNote: "炭素材料、吸着、藻類・バイオマス炭化、複合材のPJ群へ広く効く。", scores: { heat: 5, demand: 5, supplyRisk: 5, amdFit: 5 }, scoreReasons: { heat: "電池と脱炭素の両方にまたがる", demand: "負極・軽量化・吸着用途", supplyRisk: "電池grade加工が集中", amdFit: "AMDの環境・材料テーマと接点が多い" } }),
  Si: detail({ id: "element-si", family: "element", name: "ケイ素", code: "Si", category: "半金属", summary: "砂・石英から半導体、太陽電池、SiC、シリコーンへ枝分かれする巨大材料チェーン。", properties: ["半導体特性", "酸化物が安定", "純度で用途が変わる"], uses: ["半導体", "太陽電池", "SiCパワー素子", "シリコーン"], supplyCountries: ["金属Si: 中国", "ブラジル", "ノルウェー"], reserves: "地殻中に豊富で、commodityとしての埋蔵量不足より高純度石英・精製電力・製造能力が制約。", balance: "汎用品と半導体gradeを分けて見る。太陽電池は設備過剰局面でも高純度原料と先端用途は別市場。", circularity: "太陽光panel・半導体sludge・シリコーンの回収技術が未成熟。", chain: ["石英 / 高純度シリカ", "金属Si / ポリSi", "wafer / SiC / シリコーン", "半導体・太陽電池・医療"], amdFitNote: "半導体だけでなく、センサー、耐熱部材、医療・環境材料まで案件を束ねられる。", scores: { heat: 5, demand: 5, supplyRisk: 4, amdFit: 5 }, scoreReasons: { heat: "複数の成長市場を同じ原料が支える", demand: "電力半導体・PV・電子部材", supplyRisk: "高純度工程と製造能力が集中", amdFit: "deeptechの共通基盤" } }),
  P: detail({ id: "element-p", family: "element", name: "リン", code: "P", category: "非金属", summary: "食料を支える不可欠元素で、LFP電池・難燃材・電子材料にも広がる。", properties: ["生体必須", "反応性が高い", "回収しなければ散逸しやすい"], uses: ["肥料", "LFP正極", "難燃剤", "化学品"], supplyCountries: ["リン鉱石: 中国", "モロッコ", "米国", "ロシア"], reserves: "リン鉱石の世界埋蔵量 約730億t（marketable phosphate rock、USGS 2026）。モロッコが約500億t。", balance: "総量より産地集中と肥料価格、LFP拡大、下水・食品系からの回収が焦点。", circularity: "下水汚泥・焼却灰・畜産排水からのリン回収は循環経済の有力テーマ。", chain: ["リン鉱石 / 排水・汚泥", "リン酸 / 回収リン", "肥料 / LFP / 難燃剤", "農業・電池・環境"], amdFitNote: "排水処理、資源回収、農業、電池材料を一つの循環chainで扱える。", scores: { heat: 5, demand: 5, supplyRisk: 4, amdFit: 5 }, scoreReasons: { heat: "食料安全保障とLFPの交点", demand: "肥料の基礎需要＋電池", supplyRisk: "高い産地集中", amdFit: "排水・循環PJとの相性が強い" } }),
  Ti: detail({ id: "element-ti", family: "element", name: "チタン", code: "Ti", category: "遷移金属", summary: "軽量・耐食・生体適合性に優れ、航空宇宙から医療、酸化物光触媒まで用途が広い。", properties: ["高比強度", "耐食性", "生体適合性"], uses: ["航空宇宙", "医療implant", "顔料TiO2", "光触媒"], supplyCountries: ["鉱物精鉱: 中国", "モザンビーク", "南アフリカ", "豪州"], reserves: "USGSはイルメナイト・ルチル等のTi鉱物で集計。金属TiとTiO2顔料は別の供給chain。", balance: "鉱石量よりスポンジTi・溶解加工の認証と設備が参入障壁。", circularity: "航空grade scrapは価値が高いが、酸素汚染と合金混合の管理が必要。", chain: ["イルメナイト / ルチル", "TiO2 / スポンジTi", "合金 / 光触媒", "航空・医療・環境"], amdFitNote: "医工連携、表面処理、光触媒、耐食設備のテーマに展開しやすい。", scores: { heat: 4, demand: 4, supplyRisk: 3, amdFit: 5 }, scoreReasons: { heat: "航空・医療・環境で安定した技術余地", demand: "航空回復と医療用途", supplyRisk: "加工・認証が制約", amdFit: "大学発技術との接点が多い" } }),
  Mn: detail({ id: "element-mn", family: "element", name: "マンガン", code: "Mn", category: "遷移金属", summary: "鉄鋼の基礎元素であり、電池grade硫酸マンガンでは別の高純度市場が立つ。", properties: ["脱酸・合金化", "多価数", "比較的低コスト"], uses: ["鉄鋼", "NMC / LMO / LMFP電池", "化学品"], supplyCountries: ["南アフリカ", "ガボン", "豪州", "ガーナ"], reserves: "USGSのMn commodityを参照。電池grade原料は鉱石埋蔵量と別に精製能力を見る。", balance: "鉄鋼向けは巨大、電池向けは小さいが高純度化投資が焦点。", circularity: "電池black massから回収可能だが、Li/Ni/Coに比べ経済価値が低く工程設計が必要。", chain: ["マンガン鉱石", "フェロMn / 高純度硫酸Mn", "鉄鋼 / 正極材", "建設・モビリティ"], amdFitNote: "低Co正極、資源回収、安価な触媒・酸化物材料の探索に向く。", scores: { heat: 4, demand: 4, supplyRisk: 4, amdFit: 4 }, scoreReasons: { heat: "電池grade化で市場構造が変わる", demand: "鉄鋼＋新正極", supplyRisk: "鉱石と高純度精製の集中", amdFit: "電池・触媒テーマに接続" } }),
  Co: detail({ id: "element-co", family: "element", name: "コバルト", code: "Co", category: "遷移金属", summary: "高性能電池・超合金に不可欠だが、採掘と精製が集中する代表的な供給risk材料。", properties: ["高温強度", "磁性", "電池正極の安定化"], uses: ["NMC/NCA正極", "超合金", "硬質工具", "触媒"], supplyCountries: ["1 コンゴ民主共和国 73%", "2 インドネシア 14%", "3 ロシア", "4 豪州"], reserves: "世界埋蔵量 約1,200万t（Co含有量、USGS 2026）。", balance: "2025年は供給過剰と低価格を背景にDRCが輸出規制へ移行。供給量と政策riskが同時に振れる。", circularity: "電池・超合金scrapは高価値。LFP化で新規需要構成が変わる。", chain: ["銅Co鉱 / Ni laterite", "Co hydroxide / metal", "正極材 / 超合金", "電池・航空"], amdFitNote: "供給risk、電池recycling、Co-free材料の比較軸として重要。", scores: { heat: 5, demand: 4, supplyRisk: 5, amdFit: 5 }, scoreReasons: { heat: "政策・価格・技術代替が激しく動く", demand: "電池と超合金", supplyRisk: "DRC採掘と中国精製へ集中", amdFit: "代替・循環の研究テーマが明確" } }),
  Ni: detail({ id: "element-ni", family: "element", name: "ニッケル", code: "Ni", category: "遷移金属", summary: "ステンレスの主力材料。電池grade class 1と大量のlaterite由来供給を分けて見る必要がある。", properties: ["耐食性", "高温強度", "電池高容量化"], uses: ["ステンレス", "NMC/NCA正極", "超合金", "めっき"], supplyCountries: ["1 インドネシア", "2 フィリピン", "3 ロシア", "4 カナダ"], reserves: "世界埋蔵量 1.4億t超（Ni含有量、USGS 2026）。", balance: "2022年以降は一次Ni市場が供給超過。大量供給と電池grade適合、環境負荷を切り分ける。", circularity: "ステンレスscrap循環が成熟。電池からのNi回収も経済性が高い。", chain: ["laterite / sulfide ore", "NPI / matte / class 1 Ni", "ステンレス / 正極材", "建設・電池・航空"], amdFitNote: "高圧湿式製錬、低炭素精製、電池循環の技術評価に向く。", scores: { heat: 4, demand: 4, supplyRisk: 4, amdFit: 4 }, scoreReasons: { heat: "供給過剰でもgradeと炭素強度が論点", demand: "ステンレス＋電池", supplyRisk: "インドネシアへの供給集中", amdFit: "製錬・循環・電池を比較可能" } }),
  ...
  Hf: detail({ id: "element-hf", family: "element", name: "ハフニウム", code: "Hf", category: "遷移金属", summary: "zirconium精製の副産物。先端半導体のhigh-k膜、超合金、原子炉制御に使う小規模戦略材料。", properties: ["高中性子吸収", "高融点", "HfO2のhigh-k特性"], uses: ["半導体gate dielectric", "超合金", "原子炉制御棒", "plasma electrode"], supplyCountries: ["Zr精製に連動", "フランス", "中国", "ドイツ"], reserves: "定量的な世界埋蔵量は非公表。zircon / baddeleyite中にZrと共存（USGS 2026）。", balance: "Zr需要に供給が連動し、Hf価格だけで増産しにくい典型的な副産物risk。", circularity: "高価だが用途中濃度が低く、超合金scrapなど限定streamが中心。", chain: ["zircon", "Zr/Hf分離", "Hf metal / HfO2", "半導体・航空・原子力"], amdFitNote: "先端半導体・高温材料の『少量だが止まる』riskを可視化できる。", scores: { heat: 5, demand: 4, supplyRisk: 5, amdFit: 4 }, scoreReasons: { heat: "先端半導体と副産物制約", demand: "high-k・superalloy", supplyRisk: "Zr連動の小規模供給", amdFit: "半導体・高温seedに有効" } }),
};
