  ...
  return (
    ...
    >
      <div className={styles.shell}>
        ...
        {activeView === "issues" && (
        <section id="issue-hypothesis" role="tabpanel" aria-label="論点・仮説パネル">
          {/* 問いの木（spec 3-21）。旧・論点/仮説/根拠/検証/判断/決定後actionの6層リストは
              この中身へ畳んだ。別ページは作らず、このタブが唯一の入口。 */}
          <QuestionTreeView
            projectId={bundle.project.projectId}
            projectName={bundle.project.projectName}
            embedded
        ...
        {activeView === "business-model" && (
          <section id="business-model" className={styles.section} role="tabpanel" aria-label="ビジネスモデル">
