  ...
  return (
    <li className="border-b border-[#dcd5c3] last:border-b-0">
      ...
      >
        ...
        <span className={`min-w-0 truncate ${row.ballSide === "SOL側" ? "font-bold text-[#8c3329]" : "text-[#514e47]"}`} title={ballDisplay(row.ballSide, row.ballOwner)}>
          {row.ballSide === "SOL側" ? `当方ボール・${row.ballOwner}` : ballDisplay(row.ballSide, row.ballOwner)}
        </span>
    ...
    <li className="border-b border-[#dcd5c3] last:border-b-0">
      ...
      >
        ...
        <span className="flex items-center justify-between gap-2 pl-[26px] text-[10px] text-[#5f5a4d]">
          ...
          <span className={`truncate ${row.ballSide === "SOL側" ? "font-bold text-[#8c3329]" : ""}`}>ボール {row.ballSide === "SOL側" ? `当方・${row.ballOwner}` : ballDisplay(row.ballSide, row.ballOwner)}</span>
        </span>
      </a>
    </li>
  );
