...
export const SPEC_SECTIONS: SpecSectionConfig[] = [
  ...
  },
  {
    ...
    description: "L2 データリスト、5 生データ、D/M/W/H automation、outbox、採否ループ。",
    slugs: [
...
export const SPEC_CHAPTERS: SpecChapterConfig[] = [
  ...
  { slug: "3-0-l2-data-list-current-spec", title: "L2 データリスト / Cadence Writer Matrix", summary: "D/M/W/H ナンバリング、各 L2 の本来の置き場所、現状差分、移管ゲート。" },
  { slug: "3-1-l2-data-extraction-current-spec", title: "L2 データ抽出 / Outbox 仕様", summary: "5 生データ、D/M/W/H L2、Claude routine、Codex H系、outbox / cron 反映の確定仕様。" },
  ...
  { slug: "3-9-l2-protocol-current-spec", title: "L2② AMD Protocol 仕様", summary: "protocols / protocol_examples / result observations の writer、input、dedupe、通知採否、停止済みGAS境界。" },
