...
export const SPEC_SECTIONS: SpecSectionConfig[] = [
  ...
  },
  {
    ...
    slugs: ["2-1-pwa-runtime-routes", "2-2-pwa-surface-inventory-current-spec", "2-3-supabase-data-model-current-spec", "2-4-project-logo-assets-current-spec"],
  },
  {
    key: "data-automation",
...
export const SPEC_CHAPTERS: SpecChapterConfig[] = [
  ...
  { slug: "2-4-project-logo-assets-current-spec", title: "PJ Logo Assets 仕様", summary: "PJロゴの表示component、inline mention、Drive候補確認、Storage/DB保存方針、review gate。" },
