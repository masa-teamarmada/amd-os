...
export const SPEC_SECTIONS: SpecSectionConfig[] = [
  ...
  },
  {
    ...
    slugs: [
      ...
      "2-7-ui-design-code-current-spec",
      "2-8-workspace-document-deck-editor-plan",
    ],
  },
  {
    key: "data-automation",
    ...
    slugs: [
      ...
      "3-18-important-document-extraction-current-spec",
      "3-19-project-ip-current-spec",
      "3-20-project-technology-current-spec",
      "3-21-question-tree-current-spec",
      "3-22-os-project-management-plan",
    ],
  },
  {
    key: "decision-engine",
    ...
    slugs: [
      ...
      "4-9-project-org-section-current-spec",
    ],
  },
  {
    key: "governance-ops",
...
export const SPEC_CHAPTERS: SpecChapterConfig[] = [
  ...
  { slug: "2-6-bzm-theory-map-current-spec", title: "BZM 2.0 理論マップ仕様", summary: "`/bzm/map` の本人作成型論証台帳。DB-only正本、0件reset、空白作成、通常クリック編集、Cmd二点接続、非重複panel、9 relationと権限境界の契約。" },
  { slug: "2-7-ui-design-code-current-spec", title: "PWA UIデザインコード", summary: "業務画面の情報密度、比較行44〜64px、10件以下の全件表示、未確認と安全の分離、desktop/mobile実寸検証の共通規約。" },
  { slug: "2-8-workspace-document-deck-editor-plan", title: "資料室 スライドエディタ 実装計画", summary: "資料室HTMLをパワポ同様に編集するUIの設計計画。モデル(JSON)正本への反転、コンポーネント＋スロット方式、編集フレームのCSP境界、版履歴と競合検知、Phase 0〜5の実装順。" },
  ...
  { slug: "3-22-os-project-management-plan", title: "OSによるプロマネ 設計案", summary: "問いの木の「やること」1件を委託1件として扱い、議事録からの起票→本人への配信→受託→催促→検収→報酬接続をOSが担う未承認の設計案。まさの判断3点が前提。" },
  ...
  { slug: "4-9-project-org-section-current-spec", title: "《組織》セクション", summary: "スコア詳細タブに置く担い手の面。経営チームの八機能の充足を実働の記録から判定し、人・組織の観測とメンバーを並べる。" },
