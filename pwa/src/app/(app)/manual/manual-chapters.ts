...
export const MANUAL_CHAPTERS: ManualChapterConfig[] = [
  ...
  { slug: "2-9-question-tree", title: "論点・仮説の使い方", summary: "分からないことを分解し、確かめる手をぶら下げ、答えが出たものから閉じる画面。必須と代替の区別、手が止まっている問いの見つけ方、閉じ方。", topics: ["question", "decision", "planning"], screens: ["/project/{projectId}/workspace"] },
