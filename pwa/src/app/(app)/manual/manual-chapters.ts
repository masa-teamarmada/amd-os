...
export const MANUAL_CHAPTERS: ManualChapterConfig[] = [
  ...
  { slug: "6-5-admin-payouts-reward-notice-spec", title: "Admin Payouts / 支払通知書", summary: "報酬キャッシュ、本契約/別財布の確認、支払通知書 PDF、支払月判定。", topics: ["monthly", "admin-dev"], screens: ["/admin/payouts"], tables: ["payout_notices", "billing_cycles"] },
