...
export const MANUAL_CHAPTERS: ManualChapterConfig[] = [
  ...
  { slug: "2-3-pj-cockpit", title: "PJ コックピットの見方", summary: "PJ Status、MS 進捗、経営ハイライト、Slackの会話、月次カード、コスト試算タブ、スコア詳細タブの《組織》の読み方。", topics: ["cockpit", "decision", "monthly"], screens: ["/project/{projectId}/cockpit"] },
  ...
  { slug: "2-9-question-tree", title: "ゴールツリーの使い方", summary: "到達点からMS・論点・仮説・TODOへ分解して進める画面。未承認の承認、どれか1つで解ける論点の指定、手が止まっている論点の見つけ方、閉じ方。", topics: ["question", "decision", "planning"], screens: ["/project/{projectId}/workspace"] },
  ...
  { slug: "4-3-amd-score-spec", title: "AMD Score 詳細仕様", summary: "SPS (シーズ有望度、旧PRS) primary、legacy AMD comparison、算出式、未来予測修正 loop。", topics: ["decision", "cockpit"], screens: ["/venture-map/amd-score", "/project/{projectId}/cockpit"], tables: ["amd_score_inputs", "amd_score_alpha"] },
  { slug: "4-4-frl-related-members-score-spec", title: "FRL / HRL / 関連メンバー詳細仕様", summary: "Founding Readiness、関連メンバー、HRL、Grit / Resilience、BZM 3.0 の八機能と《組織》。", topics: ["decision", "cockpit", "system-dev"], tables: ["project_founding_members", "project_venture_members"] },
  ...
  { slug: "6-5-admin-payouts-reward-notice-spec", title: "Admin Payouts / 支払通知書", summary: "報酬キャッシュ、本契約/別財布の確認、支払通知書 PDF、支払月判定。シーズン予実表 (/admin/season-pl) で請求額内訳と pt単価/未割当pt/cap-原資/役員stock 検算。 PJ別利益構造 (/admin/project-profitability) でシーズン単位の収益率比較 (指標は再設計中)。", topics: ["monthly", "admin-dev"], screens: ["/admin/payouts", "/admin/season-pl", "/admin/project-profitability"], tables: ["payout_notices", "billing_cycles", "value_plan_cycles"] },
  ...
  { slug: "8-2-notification-review-and-strategy-signals-spec", title: "通知レビュー UI / 経営ハイライト確認", summary: "notifications 実 UI、経営ハイライト（入れないものの線引き含む）、修正依頼履歴。", topics: ["knowledge-dev", "decision", "cockpit"], screens: ["/notifications", "/project/{projectId}/cockpit"], tables: ["project_strategy_signals", "l2_feedbacks"] },
...
export const MANUAL_TOPIC_NODES: ManualTopicNodeConfig[] = [
  ...
  },
  {
    ...
    icon: "calendar",
    color: "emerald",
    chapterSlugs: ["2-6-admin-ops", "6-12-member-payout-flow", "2-2-member-workflows-quick-start", "6-3-invoice-and-billing-routine-spec", "6-4-finance-payment-confirm-spec", "6-5-admin-payouts-reward-notice-spec", "6-6-member-billing-prompts-spec", "6-7-contracts-management-spec", "7-1-reward-calc-spec"],
