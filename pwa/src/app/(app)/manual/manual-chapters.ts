...
export const MANUAL_CHAPTERS: ManualChapterConfig[] = [
  ...
  { slug: "4-3-amd-score-spec", title: "AMD Score 詳細仕様", summary: "PRS primary、legacy M-X-F comparison、P/R_net review、未来予測修正 loop。", topics: ["decision", "cockpit"], screens: ["/venture-map/amd-score", "/project/{projectId}/cockpit"], tables: ["amd_score_inputs", "amd_score_alpha"] },
