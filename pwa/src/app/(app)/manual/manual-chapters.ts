...
export const MANUAL_CHAPTERS: ManualChapterConfig[] = [
  ...
  { slug: "6-8-admin-ms-overview-spec", title: "Admin / MS Overview", summary: "全PJ MS設計を 1 画面で並べて pt 配分・メンバー序列を理論値で見る設計レビュー。実消化は読まない (plannedShare ベース)。", topics: ["admin-dev"], screens: ["/admin/ms-overview"], tables: ["value_plan_cycles", "value_milestones", "milestone_responsibility", "billing_cycles"] },
