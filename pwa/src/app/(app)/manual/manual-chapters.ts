...
export const MANUAL_CHAPTERS: ManualChapterConfig[] = [
  { slug: "1-1-intro", title: "AMD OS とは", summary: "OS の目的、想定ユーザー、5 生データ、L2 13 種、読み方ガイド。", topics: ["start", "system"], screens: ["/manual"], tables: ["L2 13 種"] },
  ...
  { slug: "3-2-data-and-extraction", title: "データと抽出", summary: "5 生データ、L2 13 種、抽出 pipeline、復旧状況の開発者向け正本。", topics: ["system-dev", "knowledge-dev"], tables: ["source_cache", "project_meeting_summaries", "project_strategy_signals"] },
  ...
  { slug: "4-3-amd-score-spec", title: "AMD Score 詳細仕様", summary: "Before Zero Theory、7 軸、算出式、未来予測修正 loop。", topics: ["decision", "cockpit"], screens: ["/venture-map/amd-score", "/project/{projectId}/cockpit"], tables: ["amd_score_inputs", "amd_score_alpha"] },
  ...
  { slug: "8-3-l2-extraction-routines-spec", title: "L2 Extraction Routines", summary: "L2 ①〜⑬ の現行 writer、MMOマシン automation、outbox/applier、PWA non-LLM aggregate、local BZM applier、課金ルート、復旧時に見る場所。", topics: ["knowledge-dev", "developer"], tables: ["monthly_reports", "milestone_monthly_progress", "project_knowledge", "member_knowledge", "protocols", "textbook_insight_candidates", "atlas_signals", "macro_index_log", "member_activities"] },
