...
**まさえいMTG**（= まさとえいみが 2 人で議論したセッション）の生データを、
**初めて読んだチームメンバーでも**「なぜこの議論をしたか」「議論の中で何が動いたか」
「2人でどう提案するか」「残課題は何か」がスムーズに追える、
...
## 💬 2人で出した提案（チームへの相談）
> このセクションは「まさえいMTGで議論した結果として、チームに『こうしてはどうか』と出す提案」を並べる。
...
2. **このセッションは「まさえいMTG」と呼ぶ**。「経営会議」「まさ × えいみ経営会議」とは書かない（経営会議という表現は、そこに入っていないメンバーが疎外感を持つので避ける）。raw 内に「経営会議」と書いてあっても narrative では「まさえいMTG」「次回のまさえいMTG」「2 人で議論」のように書き換える。
3. **「2人で出した提案」の表記**：「2」「人」の間にスペースを入れない（半角全角を問わず）。「2人で」とベタ書きする。
