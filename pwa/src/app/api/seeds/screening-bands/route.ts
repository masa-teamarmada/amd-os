...
// クライアントコンポーネント (CockpitKuteSeeds / KuteSeedDetailModal) はこの route 経由で読む。
// 設計正本: pwa/design/seeds.md「seed_screening_bands」節 / pwa/bzm/BZM_SEED_TIER0_SCREENING_DESIGN_2026-08-15.md §6 確定13
