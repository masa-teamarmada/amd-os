-- 298_sx_sier_static_calendar_refresh.sql
-- SIER統合計画HTMLへ9か月分の静的カレンダーを埋め込んだ後の実ファイルサイズを、
...
BEGIN
  ...
  WHERE document_id = '1c2ae58a-8460-4687-86b7-d085593044cb'
    ...
    AND display_name = '260819_SolvioraX_SIER_NewCo_integrated_plan.html';
