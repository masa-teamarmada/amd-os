...
('pte_cx_c13', 'ptt_cx_compare', 'p20', '到達温度', 'LEMON (EU)', null, null, '20mK未満 (目標値)', null,
...
('pte_cx_c52', 'ptt_cx_compare', 'p20', '販売実績', 'kiutra', null, null, '40台以上 / 顧客40機関以上', null,
 'excellent', null, null, 'high', 'vendor_spec', 'project_knowledge (p20 competitor)',
...
('pte_cx_r02', 'ptt_cx_record', 'p20', '技術成熟度 (TRL) の開始点', null, null, null, '4 から 3 へ引き下げ', null,
 null, '実証段階のため', '2026-03-01', 'high', 'meeting', 'project_knowledge (p20 tech)',
 '月内の時点。日付は月初で置いている', 20, 'amie', 'amie'),
('pte_cx_r03', 'ptt_cx_record', 'p20', 'TES と ADR を組にしたシステムの引き合い', null, 2, 2, 'KEK / JAXA 宇宙科学研究所', '件',
...
('pte_sx_c12', 'ptt_sx_compare', 'p21', '処理単価', '既存の物理化学処理', 1200, 1200, '前後', '円/m3',
...
('pte_sx_c51', 'ptt_sx_compare', 'p21', '運転に要る人手', 'SX (自社)', null, null, '年間3,000立方メートルあたり1人', null,
...
-- 到達実績
('pte_sx_r01', 'ptt_sx_record', 'p21', 'バイオ装置 (マニホールド型)', null, 180, 180, '実験室へ納品・設置', 'kg',
...
('pte_sx_r02', 'ptt_sx_record', 'p21', '技術成熟度 (TRL)', null, null, null, '5 から 6 へ移行の見込み', null,
 null, '培養実験の開始による', '2026-04-01', 'high', 'meeting', 'project_knowledge (p21 tech)',
 '月内の時点。日付は月初で置いている', 20, 'amie', 'amie'),
('pte_sx_r03', 'ptt_sx_record', 'p21', '47リットル 縦型培養装置', null, 47, 47, '試運転できる状態', 'L',
 null, null, '2026-05-01', 'high', 'meeting', 'project_knowledge (p21 tech)',
 '外部へ公開するときはヒーター部分を外し、計器類をぼかす方針', 30, 'amie', 'amie'),
('pte_sx_r04', 'ptt_sx_record', 'p21', '評価用の排水サンプル', null, 5, 5, '繊維染色3種 / 磁性材料2種', '種',
