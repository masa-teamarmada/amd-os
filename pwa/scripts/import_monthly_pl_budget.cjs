...
const inputs = {
  ...
  projects: [
    ...
    { projectId: "pj13", projectName: "SX_FY26", monthlyRevenue: 2570000, startYm: 202606, endYm: 202703, type: "fixed", memo: "SX FY2026 draft spec period is 2026-06 to 2027-03. Revenue starts from June; first cash transfer is expected at end-Aug, modeled as 2-month cash lag.", internalMemberCost: 900000, closerInternal: true, status: "confirmed", billingType: "monthly", cashDelayMonths: 2, cashStartYm: 202608 },
  ],
  fixedCosts: [
