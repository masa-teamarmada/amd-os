...
- 現状: 内部版の出願書類たたき台 `docs/ip/2026-06-01_patent_application_draft_internal.md` を作成済み。請求項1〜16、明細書主要章、要約、retrofit不足リストを含む。
- 残課題: Fig.1〜Fig.7、抽象テーブル例、疑似処理フロー、Before-Zero設立時期推奨の安全な実施例を追加する。弁理士相談前に、明細書に出してよい情報と営業秘密に残す情報を再確認する。
