...
- 現状: 内部版の出願書類たたき台 `docs/ip/2026-06-01_patent_application_draft_internal.md` を作成済み。請求項1〜16、明細書主要章、要約、retrofit不足リストに加え、Fig.1〜Fig.7の図面案、抽象テーブル例、疑似処理フロー、安全な合成実施例を追加済み。
- 残課題: 図面を特許図面として清書する。各図・抽象テーブル・疑似フローと請求項1〜16の対応表を作る。弁理士相談前に、明細書に出してよい情報と営業秘密に残す情報を再確認する。
