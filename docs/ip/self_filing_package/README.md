...
| `2026-06-02_figures_clean_draft_internal.md` | Fig.1〜Fig.8白黒線画化前提のMermaid / 参照符号付き内部提出図面候補ドラフト | 内部レビュー用ドラフトとして usable。正式提出画像ではない |
...
ただし、実提出はまだ止める。理由は、願書の個人住所 / 法人住所 / 識別番号 / 電子証明書 / 支払方法が未確認であり、Fig.1〜Fig.8は内部提出図面候補ドラフトまでで、正式提出用の黒色線画画像そのものではないため。
...
7. 図面: 現在のMermaid / 参照符号付き内部ドラフトを、白黒線画、符号付き、GIF/BMPモノクロ2値相当の提出図面へ清書。
