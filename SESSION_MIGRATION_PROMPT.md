...
4. admin payouts の月初合意gate移行月cutoffは `85ded65e`、`gateOnly=1` 後追い取得は `31b841d5` で commit/push 済み。次 owner は production build-info が `31b841d5` 以降へ追従したかと `/admin/payouts` 表示を確認する。
