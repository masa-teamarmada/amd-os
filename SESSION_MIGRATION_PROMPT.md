...
- current production at handoff: https://amd-os-pwa.vercel.app/api/build-info = `v0.39.45` / `1a37894441157b2b5d690ffa40203f702b930a9b` / `main` / `dirty=false`。ボード修正 commit は ancestor として含まれる。最新 docs closeout は main push 済みだが、production はまだ最新 docs closeout までは進んでいない。
