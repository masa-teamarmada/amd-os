...
- canonical `origin/main`: `3df5371a949d5c27eb03594ab640651872054432`。PWA本番は `v3.140.7`、`https://amd-os-pwa.vercel.app/api/build-info` で同SHAを確認済み。
...
- 正規checkout `/Users/masa/projects/AMD/amd-os` は他セッション作業を含め `d4d254a7`、`origin/main`よりahead 3 / behind 204、29パスdirty。今回の作業では触っていない。reset、stash、`git add .`、他人の変更のcommitをしない。実装が必要ならまず最新mainから使い捨てclean cloneを作る。
